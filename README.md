### Eagle Eye [![Build Status](https://travis-ci.com/aag/eagle-eye.svg?branch=master)](https://travis-ci.com/aag/eagle-eye) [![License](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)
